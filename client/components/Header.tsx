...
import { User, LogOut, Crown, ShoppingCart, Youtube, Instagram, MessageCircle, AtSign } from "lucide-react";
        ...
        <div className="lg:hidden bg-white border-t border-border">
          <div className="container mx-auto px-4 py-4">
            ...
            <nav className="space-y-4 mb-6">
              ...
              <Link to="/redes-sociales" className="block text-foreground hover:text-primary transition-colors font-medium py-2">
                {t('nav.social')}
              </Link>
              <Link to="/tienda" className="block text-foreground hover:text-primary transition-colors font-medium py-2">
                {t('nav.store')}
              </Link>
              <Link to="/sobre-nosotros" className="block text-foreground hover:text-primary transition-colors font-medium py-2">
                {t('nav.about')}
              </Link>
              <Link to="/contacto" className="block text-foreground hover:text-primary transition-colors font-medium py-2">
                {t('nav.contact')}
              </Link>
            </nav>
