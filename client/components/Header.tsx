        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-4 absolute right-4">
              <select onChange={(e) => { try { localStorage.setItem('preferred-language', e.target.value); window.location.reload(); } catch (err) {} }} defaultValue={localStorage.getItem('preferred-language') || ''} className="px-2 py-1 border border-border rounded-lg bg-white text-sm mr-2" aria-label="Language selector">
