...
const translations = {
  ...
  en: {
    ...
    'planner.paperStyle': 'Paper Style:',
    'planner.customImage': 'Upload a custom image (max 5MB):',
    'planner.paperBacking': 'Paper/backing color:',
    'planner.headerBoxes': 'Header boxes color:',
    'planner.dates': 'Select your planner dates:',
    'planner.startMonth': 'Start month:',
    'planner.startDate': 'Start date:',
    'planner.tabColors': 'Tab colors:',
    'planner.tabFont': 'Tab font color:',
    'planner.tabTitles': 'Tab titles and links:',
    'planner.dailyTime': 'Daily time start:',
    'planner.calendar': 'Apple and Google calendar links on daily pages:',
    'planner.recaptcha': 'Complete reCAPTCHA verification to generate your planner:',
    'planner.chooseFile': 'Choose File',
    'planner.noFile': 'No file chosen',
    'planner.hexColors': 'Find hex color codes',
